...
if vfai_b8 then
call DisplayTextToPlayer(vfai_u8s,0,0.25,vfai_col7[vfai_i8+36]+GetPlayerName(vfai_Hong)+"|r sedang |c000080FFmengintip|r "+vfai_col7[vfai_i9+37]+"mu :p|r!")
else
call DisplayTextToPlayer(vfai_u8s,0,0.25,vfai_col7[vfai_i8+36]+GetPlayerName(vfai_Hong)+"|r sedang |c000080FFmengintip|r "+vfai_col7[vfai_i9+37]+GetPlayerName(vfai_H7n)+"|r!")
endif
...
call DisplayTextToPlayer(vfai_p7,0,0.25,"|c00FF80C0Berhasil :D|r")
endif
endif
endfunction
...
if playerName=="kangtoojee" or playerName=="ArcHeLL"or playerName=="hunteras12"or playerName=="pein[tendo]"or playerName=="ALAY"or playerName=="dayz_sasuke"or playerName=="dayz23"or playerName=="_dayz_rikimaru_"or playerName=="siradilaa"or playerName=="zereef"or playerName=="killerx"or playerName=="setasouji"or playerName=="alucard"or playerName=="hisoka"or playerName=="accelerator"then
set vfai_ahbee[12]=2
...
endloop
call TriggerRegisterPlayerChatEvent(BeE,Player(looper),".",vfai_bl6)
set vfai_ahbee[looper+13]=1
call DisplayTextToPlayer(Player(looper),0,0,"Fai's Cheat Pack - Name Activator")
call DisplayTextToPlayer(Player(looper),0,0,"Edited by ArcHeLL (aka hunteras12 for Garena)")
set vfai_ahbee[looper]=1
endif
set looper=looper+1
endloop
set vfai_p7=null
